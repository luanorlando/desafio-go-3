...
func (x *GetOrdersResponse) GetOrders() []*CreateOrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x17.pb.CreateOrderResponseR\x06orders\"\a\n" +
	"\x05blank2}\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\x12-\n" +
	"\tGetOrders\x12\t.pb.blank\x1a\x15.pb.GetOrdersResponseB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	1, // 0: pb.GetOrdersResponse.orders:type_name -> pb.CreateOrderResponse
	0, // 1: pb.OrderService.CreateOrder:input_type -> pb.CreateOrderRequest
	3, // 2: pb.OrderService.GetOrders:input_type -> pb.blank
	1, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
	2, // 4: pb.OrderService.GetOrders:output_type -> pb.GetOrdersResponse
