...
type OrderServiceClient interface {
	...
	GetOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*GetOrdersResponse, error)
}
...
func (c *orderServiceClient) GetOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*GetOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetOrders(context.Context, *Blank) (*GetOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrders(context.Context, *Blank) (*GetOrdersResponse, error) {
...
func _OrderService_GetOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrders(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
